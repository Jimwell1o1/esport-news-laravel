        ...
        <div class="member" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="member-info">
            <div class="member-info-content">
              ...
              <div class="social">
                <a href="https://twitter.com/Jimwell1o1?s=07"><i class="bi bi-twitter"></i></a>
                <a href="https://www.facebook.com/imsotall"><i class="bi bi-facebook"></i></a>
                <a href="https://instagram.com/jimwellrbn?utm_medium=copy_link"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="member" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="member-info">
            <div class="member-info-content">
              ...
              <div class="social">
                <a href="https://mobile.twitter.com/aaroncutez"><i class="bi bi-twitter"></i></a>
                <a href="https://www.facebook.com/aaronzxc1027/"><i class="bi bi-facebook"></i></a>
                <a href="https://www.instagram.com/_eyyyyyyyy/"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="member" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="member-info">
            <div class="member-info-content">
              ...
              <div class="social">
                <a href="https://twitter.com/CarlooRaymundo?s=07"><i class="bi bi-twitter"></i></a>
                <a href="https://www.facebook.com/jancarlo.raymundo/"><i class="bi bi-facebook"></i></a>
                <a href="https://instagram.com/carloraymundo_?utm_medium=copy_link"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="member" data-aos="fade-up" data-aos-delay="400">
          ...
          <div class="member-info">
            <div class="member-info-content">
              ...
              <div class="social">
                <a href="https://twitter.com/PaclibarCarlo?s=07"><i class="bi bi-twitter"></i></a>
                <a href="https://www.facebook.com/Miraclez25"><i class="bi bi-facebook"></i></a>
                <a href="https://instagram.com/jaycpac25?utm_medium=copy_link"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
        </div>
